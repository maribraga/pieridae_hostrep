...
*/
#' #### Z-scores from all summary networks
#' 
#' After doing the previous steps for all three summary networks we can combine them
#' in one object, like the one below

Qz <- readRDS("./networks/Qz.rds")
Nz <- readRDS("./networks/Nz.rds")

pal_3c <- brewer.pal(n = 9, name = 'Blues')[c(5,7,9)]
